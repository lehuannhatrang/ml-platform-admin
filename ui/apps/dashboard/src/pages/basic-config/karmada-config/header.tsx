...
import { KarmadaHeaderProps, restartDeployment, checkDeploymentStatus, reinstallDeployment, GetPodYAML } from '@/services';
...
const KarmadaHeader: React.FC<KarmadaHeaderProps> = ({ onTabChange, appName, podNames }) => {
    ...
    return (
        <Row gutter={16} align="middle" style={{ backgroundColor: '#f5f5f5', padding: '16px 4px', borderRadius: '8px' }}>
            <Col>
